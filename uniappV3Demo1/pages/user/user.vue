<template>
	<view class="main pageBG" v-if="userInfo">
		<view class="" :style="{height:getNavBarHeight()+'px'}"></view>
		<view class="userInfo">
			<view class="avatar">
				<image src="../../static/皮卡丘.png" mode="aspectFill"></image>
			</view>
			<view class="ip">{{userInfo.IP}}</view>
			<view class="address">来自于：{{userInfo.address.province||userInfo.address.city||userInfo.address.country}}</view>
		</view>
		<view class="section">
			<view class="list">
				...
				<view class="row">
					...
					<!-- #endif -->
					<!-- #ifndef MP -->
					<button @click="contact">拨打电话</button>
					<!-- #endif -->
				</view>
			</view>
		</view>
